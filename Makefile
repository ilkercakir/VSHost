...
SOURCES=VSHost.c VStudio.c VSJam.c VSEffect.c AudioDev.c AudioMic.c AudioSpk.c AudioMixer.c AudioPipeNB.c AudioEncoder.c VSTMediaPlayer.c VSTVideoPlayer.c YUV420RGBgl.c VideoQueue.c 
OBJECTS=$(SOURCES:.c=.o)
EXECUTABLE=VSHost
